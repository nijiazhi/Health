...
<div style="margin-left:200px">
	<h1>传统算法示意图<small > --- 病人相似度</small></h1>
...
var xScale = d3.scale.linear().domain([0,800]).range([0, width]),
...
// Load the data.
d3.json("resources/js/patient_metric_learning/data_metric_learning.json", function(nations) {
