                        ...
                        <td id="doctor_feedback_3">
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <textarea id="feedback_input" class="form-control" style="width:500px;height:80px;"
                                              placeholder="请输入反馈建议内容"></textarea>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="col-md-12" style="margin-top: 15px;">
											<span class="input-group-btn"> 
												<a class="btn btn-danger" href="javascript:;"
                                                   onclick="feed_back_commit()">确定提交</a>
											</span>
                                <br/>
                                <span class="input-group-btn">
												<a class="btn btn-info" href="javascript:;"
                                                   onclick="feed_back_cancle()">取消</a>
											</span>
                            </div>
                        </td>
...
<script src="resources/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"
